...
extension AttributedStringRenderer {
  private func renderBlocks(_ blocks: [Block], state: State) -> NSMutableAttributedString {
    ...
    for (offset, block) in blocks.enumerated() {
      ...
      // TODO: This should only need to be called once. Refactor this to init code
      NSTextAttachment.registerViewProviderClass(CustomViewRendererProvider.self, forFileType: "public.data")
      
      // TODO: Refactor custom view replacements registeration to somewhere outside the renderer
      // TODO: Performance impact of these regexp evals?
