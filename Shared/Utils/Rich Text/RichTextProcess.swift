...
extension String {
    /// Convert Treehole-formatted content to basic markdown, stripping images, references and LaTeX.
    ...
    /// Convert `String` to `AttributedString` using Markdown syntax, stripping images, references and LaTeX.
