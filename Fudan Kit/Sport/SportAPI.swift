...
public enum SportAPI {
    ...
    public static func getExercise() async throws -> ([Exercise], [ExerciseLog]) {
        ...
        let data = try await Authenticator.shared.authenticate(exerciseURL, loginURL: loginURL)
    ...
    public static func getExam() async throws -> SportExam {
        ...
        let data = try await Authenticator.shared.authenticate(examURL, loginURL: loginURL)
